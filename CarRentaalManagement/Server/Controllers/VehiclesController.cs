...
public class VehiclesController : ControllerBase
{
    ...
    {
        var vehicle = await _unitOfWork.VehicleRepository.Get(q => q.Id == id);
    ...
    {
        var vechicle = await _unitOfWork.VehicleRepository.Get(q => q.Id == id);
        return vechicle == null;
    }
}
